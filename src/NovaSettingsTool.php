...
namespace codicastudio\SettingManager;

use Laravel\Nova\Nova;
use Laravel\Nova\Tool;

class SettingManagerTool extends Tool
{
    protected static $fields = [];

    public function boot()
    {
        Nova::script('setting-manager', __DIR__.'/../dist/js/tool.js');
    }

    public function renderNavigation()
    {
        return view('setting-manager::navigation');
    }
