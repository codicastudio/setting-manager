  ...
  methods: {
    async getFields() {
      ...
      const {
        ...
        .get('/nova-vendor/setting-manager/settings?editing=true&editMode=update')
        .catch(error => {
    ...
    updateRequest() {
      return Nova.request().post('/nova-vendor/setting-manager/settings', this.formData);
    },
  },
  computed: {
    formData() {
