...
namespace codicastudio\SettingManager\Http\Controllers;

use codicastudio\SettingManager\SettingManagerTool;
...
class SettingsController extends Controller
{
    ...
    public function save(NovaRequest $request)
    {
        ...
        if (config('setting-manager.reload_page_on_save', false) === true) {
    ...
    {
        return new FieldCollection(($this->filter(SettingManagerTool::getFields())));
    }

    protected function fields(Request $request)
    {
        return SettingManagerTool::getFields();
    }
}
